...
public class Receipt {
	...
	private void initialize() {
		...
		lb_Time.setText("" + oCalendar.get(Calendar.YEAR) + "³â" + (oCalendar.get(Calendar.MONTH) + 1) + "¿ù" + oCalendar.get(Calendar.DAY_OF_MONTH)
		 + "ÀÏ " + oCalendar.get(Calendar.HOUR_OF_DAY) + "½Ã " + oCalendar.get(Calendar.MINUTE) + "ºÐ");
